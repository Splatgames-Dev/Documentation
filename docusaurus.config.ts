...
const url = (preview && `https://${env.VERCEL_URL}`) || "https://docs.splatgames.de";

const docsCommon: Options = {
  breadcrumbs: true,
  editUrl: ({ versionDocsDirPath, docPath }) =>
    `https://github.com/splatgames-dev/Documentation/blob/main/${versionDocsDirPath}/${docPath}`,
...
const config: Config = {
  ...
  tagline:
    "Dokumentation für alle Projekte unter Splatgames.de, einschließlich der CityBuild-API und allgemeiner Dokumentation über den Server.",
  url: url,
  baseUrl: "/",
